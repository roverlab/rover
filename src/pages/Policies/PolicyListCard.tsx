...
export function PolicyListCard({
    ...
    }, [policies, searchQuery, selectedPolicyIds, statusFilter, t]);
        ...
        <Card className="overflow-hidden p-0">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[var(--app-divider)] bg-[rgba(255,255,255,0.6)] px-3 py-2">
                ...
                <div className="flex flex-wrap items-center gap-1.5">
                    ...
                    <Button variant="secondary" size="sm" className="h-7 px-2 text-[11px]" onClick={onImportTemplate}><Download className="w-3 h-3 mr-1" />{t('common.import')}</Button>
                    ...
                    <table className="data-table w-full">
                        <thead className="sticky top-0 z-10 border-b border-[var(--app-divider)] bg-[rgba(248,249,251,0.95)]">
                            <tr className="h-9">
                                ...
                                <th className="w-[100px] min-w-[100px] px-3 py-1.5 text-center text-[11px] font-medium text-[var(--app-text-quaternary)] whitespace-nowrap">{t('policies.tableColOutbound')}</th>
                                <th className="min-w-[120px] px-3 py-1.5 text-left text-[11px] font-medium text-[var(--app-text-quaternary)] whitespace-nowrap">{t('policies.tableColPreferredOutbound')}</th>
