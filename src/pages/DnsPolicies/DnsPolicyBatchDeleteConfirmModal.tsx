...
interface DnsPolicyBatchDeleteConfirmModalProps {
    open: boolean;
    count: number;
    onConfirm: () => void;
    onClose: () => void;
...
export function DnsPolicyBatchDeleteConfirmModal({
    open,
    count,
    onConfirm,
    onClose,
}: DnsPolicyBatchDeleteConfirmModalProps) {
            ...
            <div className="fixed inset-0 z-[250] flex items-center justify-center p-4">
                ...
                >
                    <div className="p-6 text-center">
                        ...
                        <h3 className="text-[15px] font-semibold text-[var(--app-text)] mb-2">{t('dnsPolicies.batchDeleteConfirmTitle')}</h3>
                        <p className="text-[13px] text-[var(--app-text-secondary)]">
                            {t('dnsPolicies.batchDeleteConfirmMessageShort', { count })}
                        </p>
